<aside class="sidebar">
    <a href="#" class="sidebar-logo">
        <div class="d-flex justify-content-start align-items-center">
            <img src="{{ url('/assets/img/global/logo.png')}}" alt="Logo" width="50" height="50">
            <span>SPP Al Ulum</span>
        </div>
    ...
    <a href="{{route('transactions.index')}}" class="sidebar-item {{ (request()->is('dashboard/transactions*')) ? 'active' : ''}}" onclick="toggleActive(this)">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-credit-card"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
        <span>{{ Auth::user()->roles == 'User' ? 'Transaksi Siswa' : 'Pembayaran' }}</span>
    </a>

    <h5 class="sidebar-title">Report</h5>
    <form action="{{ route('reports.arrears') }}" method="POST">
        @csrf
        <input type="hidden" name="tingkat" value="full">
        <input type="hidden" name="date" value="{{ \Carbon\Carbon::today()->format('n') }}">
        <button type="submit" class="sidebar-item w-100 {{ (request()->is('dashboard/report/arrears')) ? 'active' : '' }}" onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
    ...
    <form action="{{ route('reports.discount') }}" method="POST">
        @csrf
        <input type="hidden" name="tingkat" value="full">
        <input type="hidden" name="potongan" value="full">
        <input type="hidden" name="startDate" value="{{ \Carbon\Carbon::today()->format('Y-m-d') }}">
        <input type="hidden" name="endDate" value="{{ \Carbon\Carbon::today()->format('Y-m-d') }}">
        <button type="submit" class="sidebar-item w-100 {{ (request()->is('dashboard/report/discount')) ? 'active' : '' }}" onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
    ...
    <form action="{{ route('reports.daily') }}" method="POST">
        ...
        <button type="submit" class="sidebar-item w-100 {{ (request()->is('dashboard/report/daily')) ? 'active' : '' }}" onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
    ...
    <form action="{{ route('reports.monthly') }}" method="POST">
        @csrf
        <input type="hidden" name="tingkat" value="full">
        <input type="hidden" name="date" value="{{ \Carbon\Carbon::today()->format('Y-m') }}">
        <button type="submit" class="sidebar-item w-100 {{ (request()->is('dashboard/report/monthly')) ? 'active' : '' }}" onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
    ...
    <form action="{{ route('reports.semester') }}" method="POST">
        @csrf
        <input type="hidden" name="tingkat" value="full">
        <input type="hidden" name="semester" value="Ganjil">
        <input type="hidden" name="date" value="{{ \Carbon\Carbon::today()->format('Y') }}">
        <button type="submit" class="sidebar-item w-100 {{ (request()->is('dashboard/report/semester')) ? 'active' : '' }}" onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
    ...
    <form action="{{ route('reports.yearly') }}" method="POST">
        ...
        <input type="hidden" name="tingkat" value="full">
        <input type="hidden" name="date" value="{{ \Carbon\Carbon::today()->format('Y') }}">
        <button type="submit" class="sidebar-item w-100 {{ (request()->is('dashboard/report/yearly')) ? 'active' : '' }}" onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
    ...
    <form action="{{ route('reports.schoolYear') }}" method="POST">
        @csrf
        <input type="hidden" name="tingkat" value="full">
        <input type="hidden" name="date" value="{{date('Y', strtotime('-1 year'))}}/{{date('Y')}}">
        <button type="submit" class="sidebar-item w-100 {{ (request()->is('dashboard/report/schoolYear')) ? 'active' : '' }}" onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
    
            <span>Laporan Tahun Ajaran</span>
        </button>
    ...
    @if (Auth::user()->roles == 'Admin')
        ...
        <a href="{{ route('students.index') }}" class="sidebar-item {{ (request()->is('dashboard/students*')) ? 'active' : '' }}" onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ABB3C4" class="w-6 h-6">
        ...
        <a href="{{ route('discount.index') }}" class="sidebar-item {{ (request()->is('dashboard/discount*')) ? 'active' : '' }}" onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-percent"><line x1="19" y1="5" x2="5" y2="19"></line><circle cx="6.5" cy="6.5" r="2.5"></circle><circle cx="17.5" cy="17.5" r="2.5"></circle></svg>
                
            <span>Data Potongan</span>
        </a>

        <a href="{{ route('fees.index') }}" class="sidebar-item {{ (request()->is('dashboard/fees*')) ? 'active' : '' }}" onclick="toggleActive(this)">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="{{ route('schoolYears.index') }}" class="sidebar-item {{ (request()->is('dashboard/schoolYears*')) ? 'active' : '' }}" onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
    ...
    @if (Auth::user()->roles == 'Super Admin')
        ...
        <a href="{{ route('user.table') }}" class="sidebar-item {{ (request()->is('dashboard/users*')) ? 'active' : '' }}" onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-key"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"></path></svg>
    ...
    {{-- <a href="{{ route('transactions.fillId') }}" class="sidebar-item" onclick="toggleActive(this)">
    ...
    @if (Auth::user()->roles == 'Super Admin' || Auth::user()->roles == 'Admin')
        <a href="{{ route('broadcast.index') }}" class="sidebar-item {{ (request()->is('dashboard/broadcast*')) ? 'active' : '' }}" onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>

            <span>Pesan Broadcast</span>
        </a>

        <a href="{{ route('settings.index') }}" class="sidebar-item {{ (request()->is('dashboard/settings*')) ? 'active' : '' }}" onclick="toggleActive(this)">
