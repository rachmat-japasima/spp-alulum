<aside class="sidebar">
    <a href="#" class="sidebar-logo">
        <div class="d-flex justify-content-start align-items-center">
            ...
            <span>SPP Al Ulum <br> Terpadu</span>
        </div>
    ...
    <a href="{{ route('transactions.index') }}"
        class="sidebar-item {{ request()->is('dashboard/transactions*') ? 'active' : '' }}"
        onclick="toggleActive(this)">
    ...
    <form action="{{ route('reports.arrears') }}" method="POST">
        ...
        <button type="submit"
            class="sidebar-item w-100 {{ request()->is('dashboard/report/arrears') ? 'active' : '' }}"
            onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    <form action="{{ route('reports.discount') }}" method="POST">
        ...
        <button type="submit"
            class="sidebar-item w-100 {{ request()->is('dashboard/report/discount') ? 'active' : '' }}"
            onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="feather feather-file-text">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                <polyline points="14 2 14 8 20 8"></polyline>
                <line x1="16" y1="13" x2="8" y2="13"></line>
    ...
    <form action="{{ route('reports.daily') }}" method="POST">
        ...
        <button type="submit"
            class="sidebar-item w-100 {{ request()->is('dashboard/report/daily') ? 'active' : '' }}"
            onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="feather feather-file-text">
    ...
    <form action="{{ route('reports.monthly') }}" method="POST">
        ...
        <button type="submit"
            class="sidebar-item w-100 {{ request()->is('dashboard/report/monthly') ? 'active' : '' }}"
            onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="feather feather-file-text">
    ...
    <form action="{{ route('reports.semester') }}" method="POST">
        ...
        <button type="submit"
            class="sidebar-item w-100 {{ request()->is('dashboard/report/semester') ? 'active' : '' }}"
            onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="feather feather-file-text">
    ...
    <form action="{{ route('reports.yearly') }}" method="POST">
        ...
        <input type="hidden" name="date" value="{{ \Carbon\Carbon::today()->format('Y') }}">
        <button type="submit"
            class="sidebar-item w-100 {{ request()->is('dashboard/report/yearly') ? 'active' : '' }}"
            onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="feather feather-file-text">
    ...
    <form action="{{ route('reports.schoolYear') }}" method="POST">
        ...
        <button type="submit"
            class="sidebar-item w-100 {{ request()->is('dashboard/report/schoolYear') ? 'active' : '' }}"
            onclick="toggleActive(this)" style="border: 0px;">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="feather feather-file-text">
    ...
    @if (Auth::user()->roles == 'Admin')
        ...
        <a href="{{ route('students.index') }}"
            class="sidebar-item {{ request()->is('dashboard/students*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="#ABB3C4" class="w-6 h-6">
        ...
        <a href="{{ route('discount.index') }}"
            class="sidebar-item {{ request()->is('dashboard/discount*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="{{ route('fees.index') }}"
            class="sidebar-item {{ request()->is('dashboard/fees*') ? 'active' : '' }}" onclick="toggleActive(this)">
        ...
        <a href="{{ route('schoolYears.index') }}"
            class="sidebar-item {{ request()->is('dashboard/schoolYears*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
    ...
    @if (Auth::user()->roles == 'Super Admin' || Auth::user()->roles == 'Admin')
        <a href="{{ route('broadcast.index') }}"
            class="sidebar-item {{ request()->is('dashboard/broadcast*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                fill="none" stroke="#ABB3C4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <a href="{{ route('settings.index') }}"
            class="sidebar-item {{ request()->is('dashboard/settings*') ? 'active' : '' }}"
            onclick="toggleActive(this)">
