                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 class="my-1 text-info">{{ $siswa->where('tingkat', 'RA')->count() }} Orang
                                        </h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 class="my-1 text-danger">{{ $siswa->where('tingkat', '0')->count() }} Orang
                                        </h4>
                                        {{-- <p class="mb-0 font-13">Orang</p> --}}
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 class="my-1 text-primary">{{ $siswa->where('tingkat', '1')->count() }} Orang
                                        </h4>
                                        {{-- <p class="mb-0 font-13">Orang</p> --}}
                                    </div>
                                    <div
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h4 class="my-1 text-dark">{{ $siswa->where('tingkat', '2')->count() }} Orang
                                        </h4>
                                        {{-- <p class="mb-0 font-13">Orang</p> --}}
                                    </div>
        ...
        <script>
            $(document).ready(function() {
                $.ajax({
                    ...
                    console.error('getData error:', xhr.responseText);
                });
            })
        </script>
    @endpush
