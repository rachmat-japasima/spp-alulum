                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama" id="nama"
                                    value="{{ old('nama') }}" required placeholder="Nama Potongan">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control" min="0" name="besaran"
                                        id="besaran" value="{{ old('besaran') }}" required placeholder="0">
                            ...
                            <div class="col-sm-10">
                                <select name="jenis" id="jenis" class="form-select" required>
                                    <option value="Uang Sekolah"
                                        {{ old('jenis') == 'Uang Sekolah' ? 'selected' : '' }}>Uang Sekolah</option>
                                    <option value="Uang Pembangunan"
                                        {{ old('jenis') == 'Uang Pembangunan' ? 'selected' : '' }}>Uang Pembangunan
                                    </option>
                                    <option value="Uang Pemeliharaan dan Pengembangan"
                                        {{ old('jenis') == 'Uang Pemeliharaan dan Pengembangan' ? 'selected' : '' }}>
