        ...
        <div class="row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama" id="nama"
                                    value="{{ old('nama', $data->nama) }}" required placeholder="Nama Potongan">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control" min="0" name="besaran"
                                        id="besaran" value="{{ old('besaran', $data->besaran) }}" required
                                        placeholder="0">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <select name="jenis" id="jenis" class="form-select" required>
                                    <option value="Uang Sekolah"
                                        {{ old('jenis', $data->jenis) == 'Uang Sekolah' ? 'selected' : '' }}>Uang
                                        Sekolah</option>
                                    <option value="Uang Pembangunan"
                                        {{ old('jenis', $data->jenis) == 'Uang Pembangunan' ? 'selected' : '' }}>Uang
                                        Pembangunan</option>
                                    <option value="Uang Pemeliharaan dan Pengembangan"
                                        {{ old('jenis', $data->jenis) == 'Uang Pemeliharaan dan Pengembangan' ? 'selected' : '' }}>
                                        Uang Pemeliharaan dan Pengembangan</option>
                                </select>
            ...
            <div class="col-12">
                <div class="statistics-card">
                    ...
                    <button type="button" class="col-sm-2 btn btn-form me-auto" data-bs-toggle="modal"
                        ...
                        <tbody>
                            ...
                            @foreach ($discountStudent as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->status }}</td>
                                    <td>
                                        <a href="{{ route('discount.removeStudent', $item->id) }}"
                                            onclick="return confirm('Apakah kamu yakin ingin menghapus ini ?');"
                                            class="btn btn-danger btn-sm" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Hapus"><img
                                                src="{{ url('/assets/img/global/trash.svg') }}" width="20"
                                                alt="Hapus"></a>
                                    </td>
                                </tr>
                            @endforeach
                    ...
                    <form method="post" action="{{ route('discount.addStudent') }}" class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="status" required
                                value="{{ Auth::user()->roles == 'Super Admin' ? 'Active' : 'Active' }}">
                            <select name="id_siswa" id="id_siswa" class="form-select" required autofocus
                                data-placeholder="Pilih Siswa...">
                                <option></option>
                                @foreach ($students as $item)
                                    <option value="{{ $item->id }}">{{ $item->nis }} - {{ $item->nama }}
                                    </option>
                                @endforeach
                            </select>
