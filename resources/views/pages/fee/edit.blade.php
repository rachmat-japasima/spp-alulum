                ...
                <div class="col-12">
                    <div class="row justify-content-between">
                        <div class="col-10">
                            ...
                            <h5 class="content-desc mb-4">{{ __('Edit data potongan untuk aplikasi SPP Al Ulum.') }}
                            </h5>
                        </div>
                        <div class="col-auto">
                                            ...
                                            <div class="col-sm-8">
                                                <select id="tahun_angkatan" class="form-select" disabled required>
                                                    <option value="{{ date('Y', strtotime('-3 year')) }}"
                                                        {{ old('tahun_angkatan', $data->tahun_angkatan) == date('Y', strtotime('-3 year')) ? 'selected' : '' }}>
                                                        {{ date('Y', strtotime('-3 year')) }}</option>
                                                    <option value="{{ date('Y', strtotime('-2 year')) }}"
                                                        {{ old('tahun_angkatan', $data->tahun_angkatan) == date('Y', strtotime('-2 year')) ? 'selected' : '' }}>
                                                        {{ date('Y', strtotime('-2 year')) }}</option>
                                                    <option value="{{ date('Y', strtotime('-1 year')) }}"
                                                        {{ old('tahun_angkatan', $data->tahun_angkatan) == date('Y', strtotime('-1 year')) ? 'selected' : '' }}>
                                                        {{ date('Y', strtotime('-1 year')) }}</option>
                                                    <option value="{{ date('Y') }}"
                                                        {{ old('tahun_angkatan', $data->tahun_angkatan) == date('Y') ? 'selected' : '' }}>
                                                        {{ date('Y') }}</option>
                                                    <option value="{{ date('Y', strtotime('1 year')) }}"
                                                        {{ old('tahun_angkatan', $data->tahun_angkatan) == date('Y', strtotime('1 year')) ? 'selected' : '' }}>
                                                        {{ date('Y', strtotime('1 year')) }}</option>
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control money" inputmode="numeric"
                                                        ...
                                                        value="{{ old('seleksi_masuk', $data->seleksi_masuk) }}"
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control money"
                                                        ...
                                                        value="{{ old('ra', $data->ra) }}" required placeholder="0">
                                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_1" id="kelas_1"
                                                value="{{ old('kelas_1', $data->kelas_1) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_2" id="kelas_2"
                                                value="{{ old('kelas_2', $data->kelas_2) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_3" id="kelas_3"
                                                value="{{ old('kelas_3', $data->kelas_3) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_4" id="kelas_4"
                                                value="{{ old('kelas_4', $data->kelas_4) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_5" id="kelas_5"
                                                value="{{ old('kelas_5', $data->kelas_5) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_6" id="kelas_6"
                                                value="{{ old('kelas_6', $data->kelas_6) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_7" id="kelas_7"
                                                value="{{ old('kelas_7', $data->kelas_7) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_8" id="kelas_8"
                                                value="{{ old('kelas_8', $data->kelas_8) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_9" id="kelas_9"
                                                value="{{ old('kelas_9', $data->kelas_9) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_10" id="kelas_10"
                                                value="{{ old('kelas_10', $data->kelas_10) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_11" id="kelas_11"
                                                value="{{ old('kelas_11', $data->kelas_11) }}" required
                                                placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="text" class="form-control money" inputmode="numeric"
                                                name="kelas_12" id="kelas_12"
                                                value="{{ old('kelas_12', $data->kelas_12) }}" required
                                                placeholder="0">
                                        </div>
