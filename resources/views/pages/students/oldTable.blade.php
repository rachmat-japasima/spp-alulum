    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                ...
                <h5 class="content-desc mb-4">{{ __("Kelola data siswa lama dari aplikasi SPP Al Ulum.") }}</h5>
            </div>
        

            <div class="col-12">
                <div class="statistics-card">
                    <a href="{{ route('students.index') }}" class="btn btn-success btn-radius mb-3 me-auto">
                        <img src="{{url('/assets/img/global/table-white.svg')}}" width="20" alt="">
                        Siswa Sekarang
                    </a>
