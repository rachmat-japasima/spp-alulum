<x-app-layout>
    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                <h2 class="content-title">{{ __('Edit Data Siswa') }}</h2>
                <h5 class="content-desc mb-4">{{ __("Edit data siswa untuk aplikasi SPP Al Ulum.") }}</h5>
            </div>
                ...
                <div class="statistics-card">
                        ...
                        <form method="post" action="{{ route('students.update', $data->id) }}">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nis" id="nis" value="{{old('nis', $data->nis)}}" required autofocus placeholder="Nomor Induk Siswa">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" id="nama" value="{{old('nama', $data->nama)}}" required placeholder="Nama Lengkap">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" value="{{old('tempat_lahir', $data->tempat_lahir)}}" required placeholder="Kota Lahir">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" value="{{old('tgl_lahir', $data->tgl_lahir)}}" required>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-select" required>
                                        <option value="0" {{ old('jenis_kelamin', $data->jenis_kelamin) == "0" ? 'selected' : ''}}>Laki-laki</option>
                                        <option value="1" {{ old('jenis_kelamin', $data->jenis_kelamin) == "1" ? 'selected' : ''}}>Perempuan</option>
                                    </select>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="agama" id="agama" class="form-select" required>
                                        <option value="0" {{ old('agama', $data->agama) == "0" ? 'selected' : ''}}>Islam</option>
                                    </select>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="alamat" id="alamat" rows="3" style="height: 70px" class="form-control" required>{{old('alamat', $data->alamat)}}</textarea>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_ortu" id="nama_ortu" value="{{old('nama_ortu', $data->nama_ortu)}}" required placeholder="Nama Orang Tua Siswa">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="telp_ortu" id="telp_ortu" value="{{old('telp_ortu', $data->telp_ortu)}}" required placeholder="Nomor Telepon Orang Tua Siswa">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pekerjaan_ortu" id="pekerjaan_ortu" value="{{old('pekerjaan_ortu', $data->pekerjaan_ortu)}}" required placeholder="Pekerjaan Orang Tua Siswa">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="tingkat" id="tingkat" class="form-select" required>
                                        <option value="RA" {{ old('tingkat', $data->tingkat) == "RA" ? 'selected' : ''}}>RA</option>
                                        <option value="0" {{ old('tingkat', $data->tingkat) == "0" ? 'selected' : ''}}>SD</option>
                                        <option value="1" {{ old('tingkat', $data->tingkat) == "1" ? 'selected' : ''}}>SMP</option>
                                        <option value="2" {{ old('tingkat', $data->tingkat) == "2" ? 'selected' : ''}}>SMA</option>
                                    </select>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="kelas" id="kelas" class="form-select" required>
                                        <option value="RA" {{ old('kelas', $data->kelas) == "RA" ? 'selected' : ''}}>RA</option>
                                        <option value="1" {{ old('kelas', $data->kelas) == "1" ? 'selected' : ''}}>1</option>
                                        <option value="2" {{ old('kelas', $data->kelas) == "2" ? 'selected' : ''}}>2</option>
                                        <option value="3" {{ old('kelas', $data->kelas) == "3" ? 'selected' : ''}}>3</option>
                                        <option value="4" {{ old('kelas', $data->kelas) == "4" ? 'selected' : ''}}>4</option>
                                        <option value="5" {{ old('kelas', $data->kelas) == "5" ? 'selected' : ''}}>5</option>
                                        <option value="6" {{ old('kelas', $data->kelas) == "6" ? 'selected' : ''}}>6</option>
                                        <option value="7" {{ old('kelas', $data->kelas) == "7" ? 'selected' : ''}}>7</option>
                                        <option value="8" {{ old('kelas', $data->kelas) == "8" ? 'selected' : ''}}>8</option>
                                        <option value="9" {{ old('kelas', $data->kelas) == "9" ? 'selected' : ''}}>9</option>
                                        <option value="10" {{ old('kelas', $data->kelas) == "10" ? 'selected' : ''}}>10</option>
                                        <option value="11" {{ old('kelas', $data->kelas) == "11" ? 'selected' : ''}}>11</option>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="grup" id="grup" value="{{old('grup', $data->grup)}}" required placeholder="A">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="smasuk" id="smasuk" class="form-select" required>
                                        <option value="0" {{ old('smasuk', $data->smasuk) == "0" ? 'selected' : ''}}>Reguler</option>
                                        <option value="1" {{ old('smasuk', $data->smasuk) == "1" ? 'selected' : ''}}>Pindahan</option>
                                    </select>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="asal_kelas" id="asal_kelas" value="{{old('asal_kelas', $data->asal_kelas)}}" placeholder="Asal Kelas Sebelumnya">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="asal_sekolah" id="asal_sekolah" value="{{old('asal_sekolah', $data->asal_sekolah)}}" placeholder="Asal Sekolah Sebelumnya">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="tmt_masuk" id="tmt_masuk" value="{{old('tmt_masuk', $data->tmt_masuk)}}" required>
