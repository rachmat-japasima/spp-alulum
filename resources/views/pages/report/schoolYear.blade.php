    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                ...
                <h5 class="content-desc mb-4">{{ __("Laporan transaksi pembayaran tahun ajaran untuk aplikasi SPP Al Ulum.") }}</h5>
            </div>
            @if ($errors->any())
                            ...
                            <div class="col-3">
                                <select class="form-select" name="date" id="date" required>
                                    @foreach ($listSchoolYear as $item)
                                        <option value="{{$item->tahun_ajaran}}" {{ old('date', $filters->date) == $item->tahun_ajaran ? 'selected' : '' }}>{{$item->tahun_ajaran}}</option>
                                    @endforeach
                                  </select>
                    ...
                    context: document.body
                        ...
                        Highcharts.chart('lineChart', {
                            ...
                            xAxis: {
                                ...
                                categories : [null, 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember', 'Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni']
                            },
                            ...
                            tooltip: {
                                ...
                                pointFormat: '<span style="color:{point.color}">\u25CF</span> <b> {point.name}</b><br/>' +
                                        ...
                                        'Bulan: <b>{point.x.categories}</b><br/>'
                            },
                            plotOptions: {
                                series: {
                                    label: {
