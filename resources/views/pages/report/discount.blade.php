<x-app-layout>
    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                ...
                <h5 class="content-desc mb-4">{{ __('Laporan transaksi dengan potongan untuk aplikasi SPP Al Ulum.') }}
                </h5>
            </div>
            @if ($errors->any())
            ...
            <div class="col-12">
                <div class="statistics-card card">
                    <figure>
                        ...
                        <p class="text-center">Data Transaksi Potongan
                            {{ \Carbon\Carbon::parse($filters->startDate)->format('d/m/Y') }} -
                            {{ \Carbon\Carbon::parse($filters->endDate)->format('d/m/Y') }}</p>
                    </figure>
                </div>
            </div>
            <div class="col-12">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <select class="form-select" name="potongan" id="potongan" required>
                                    <option value="full"
                                        {{ old('potongan', $filters->potongan) == 'full' ? 'selected' : '' }}>Semua
                                    </option>
    ...
    @php
        $pieChart = [];
        foreach ($dataPotongan as $value) {
            $y = (int) $value->total_pot;
            $pieChart[] = (object) [
                'name' => $value->discount->nama,
                'y' => $y,
                'z' => $y, // penting untuk variablepie
            ];
        }
    @endphp
