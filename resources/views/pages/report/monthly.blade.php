<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Laporan Transaksi Pembayaran Bulanan') }}
        </h2>
    </x-slot>
    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                <h2 class="content-title">{{ __('Laporan Transaksi Pembayaran Bulanan') }}</h2>
                <h5 class="content-desc mb-4">
                    {{ __('Laporan transaksi pembayaran bulanan untuk aplikasi SPP Al Ulum.') }}</h5>
            </div>
            @if ($errors->any())
            ...
            <div class="col-12">
                <div class="statistics-card card">
                    <figure>
                        ...
                        <p class="text-center">Data Bulan {{ date('F Y', strtotime($filters->date)) }}</p>
                    </figure>
                </div>
            </div>
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <input type="month" class="form-control" name="date"
                                    value="{{ old('date', $filters->date) }}" required />
    ...
    @push('addon-scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                $.ajax({
                    method: "POST",
                    url: "{{ route('reports.getDiagramDataMonthly') }}",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    data: {
                    ...
                    Highcharts.chart('lineChart', {
                        ...
                        title: {
                            text: 'Laporan Transaksi Pembayaran Bulanan',
                            align: 'left'
                        },
