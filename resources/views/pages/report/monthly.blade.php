    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                ...
                <h5 class="content-desc mb-4">{{ __("Laporan transaksi pembayaran bulanan untuk aplikasi SPP Al Ulum.") }}</h5>
            </div>
            @if ($errors->any())
            ...
            <div class="col-12 col-md-6">
                <div class="statistics-card card">
                    <figure>
                        ...
                        <p class="text-center">Total Transaksi : <span id="totalTransaksi">0</span></p>
                    </figure>
                </div>
            </div>
            <div class="col-12 col-md-6">
                           ...
                           <div class="card-body">
                               <div class="d-flex align-items-center">
                                   <div>
                                       ...
                                       <h4 class="my-1 text-light" id="total_uang_sekolah">Ro. 0</h4>
                ...
                <div class="statistics-card card">
                    ...
                    <form action="{{ route('reports.monthly') }}" method="POST">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-auto">
                                <input type="month" class="form-control" name="date" value="{{ old('date', $filters->date) }}" required/>
