    ...
    <div class="content">
        <div class="row">
            <div class="col-12">
                ...
                <h5 class="content-desc mb-4">{{ __("Laporan transaksi pembayaran per semester untuk aplikasi SPP Al Ulum.") }}</h5>
            </div>
            @if ($errors->any())
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-2">
                                <select class="form-select" name="semester" id="semester" required>
                                  <option value="Ganjil" {{ old('semester', $filters->semester) == 'Ganjil' ? 'selected' : '' }}>Ganjil</option>
                                  <option value="Genap" {{ old('semester', $filters->semester) == 'Genap' ? 'selected' : '' }}>Genap</option>
                                </select>
                                <x-input-error class="mt-2 text-danger" :messages="$errors->get('tingkat')" />
                              </div>
                            <div class="col-2">
                            ...
                            <div class="col-auto d-flex justify-content-end">
                                <form action="{{ route('reports.printResume') }}" method="POST" target="_blank">
                                    ...
                                    <input type="hidden" name="semester" value="{{ $filters->date }}">
