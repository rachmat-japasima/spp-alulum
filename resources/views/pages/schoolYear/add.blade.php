                            ...
                            <div class="statistics-card">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control" min="0" name="pembangunan_ra" id="pembangunan_ra" value="{{old('pembangunan_ra')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="pembangunan_sd" id="pembangunan_sd" value="{{old('pembangunan_sd')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="pembangunan_smp" id="pembangunan_smp" value="{{old('pembangunan_smp')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="pembangunan_sma" id="pembangunan_sma" value="{{old('pembangunan_sma')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="seleksi_masuk" id="seleksi_masuk" value="{{old('seleksi_masuk')}}" required placeholder="0">
                                        </div>
                            ...
                            <div class="statistics-card">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="ra" id="ra" value="{{old('ra')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_1" id="kelas_1" value="{{old('kelas_1')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_2" id="kelas_2" value="{{old('kelas_2')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_3" id="kelas_3" value="{{old('kelas_3')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_4" id="kelas_4" value="{{old('kelas_4')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_5" id="kelas_5" value="{{old('kelas_5')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_6" id="kelas_6" value="{{old('kelas_6')}}" required placeholder="0">
                                        </div>
                            ...
                            <div class="statistics-card">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_7" id="kelas_7" value="{{old('kelas_7')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_8" id="kelas_8" value="{{old('kelas_8')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_9" id="kelas_9" value="{{old('kelas_9')}}" required placeholder="0">
                                        </div>
                            ...
                            <div class="statistics-card">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_10" id="kelas_10" value="{{old('kelas_10')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_11" id="kelas_11" value="{{old('kelas_11')}}" required placeholder="0">
                                        </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Rp.</span>
                                            <input type="number" class="form-control" min="0" name="kelas_12" id="kelas_12" value="{{old('kelas_12')}}" required placeholder="0">
                                        </div>
